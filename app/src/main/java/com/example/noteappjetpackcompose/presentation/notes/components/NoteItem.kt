...
fun NoteItem(
    ...
    Box(modifier = modifier) {
        // The diffrent between matchParentSize() and fillMaxSize() is matchParentSize get whole parent
        // size but fillMaxSize get whole screen size and change parent size
